...
public class DelectPsRoomSearchListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{

    private Context mContext;

    private List<DelectPsRoomSearchListResponses> mRoomList = new ArrayList<>();


    private ClickCallback mClickCallback;

    public DelectPsRoomSearchListAdapter(Context context, List<DelectPsRoomSearchListResponses> roomList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        GlideUtils.setCircleImage(mContext,myViewHolder.imageView,rommSearchResponses.getRoomView().getImagePath(),R.mipmap.ic_launcher);
